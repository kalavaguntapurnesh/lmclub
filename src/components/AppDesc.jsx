          ...
          <div className="w-full px-4 mx-auto max-w-[1400px]">
            ...
            <div className="mx-auto max-w-[1200px] ">
              <div class="grid md:grid-cols-2 grid-cols-1 gap-6 pt-8">
                <div class="w-full bg-stone-50 border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                  <div className="flex flex-col">
                    <div className="grid grid-cols-4 w-[100%] border-b-[1px] border-stone-200">
                      ...
                      <div className="lg:col-span-2 col-span-4 bg-gray-300">
                        <img
                          src="https://images.pexels.com/photos/45853/grey-crowned-crane-bird-crane-animal-45853.jpeg?auto=compress&cs=tinysrgb&w=1200"
                          alt=""
                    ...
                    <div className="p-4 text-gray-600 md:text-start text-center">
                      <p className="pt-4 pb-4">
                        ...
                        enim inventore harum voluptas, incidunt aut explicabo ea
                        possimus odio eius magni dicta? Neque, optio suscipit!
                      </p>
                    </div>
                  </div>
                </div>

                <div class="w-full bg-green-50 border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                  <div className="flex flex-col">
