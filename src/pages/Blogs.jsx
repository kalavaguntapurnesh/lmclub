                ...
                >
                  ...
                  <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 pt-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-xl font-bold">
                        <p>
                        Tips for Success with LM Club Grow Rewards
                        </p>
                      </div>

                      <div className="text-gray-500">
                        <p>
                        Share your LM Club experience and its benefits to inspire others. 
                        Track referrals, stay motivated, and engage regularly for rewards!
                        </p>
                      </div>
                    </div>
                  </div>
