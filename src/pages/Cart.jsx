  ...
  return (
    <div>
      ...
      <div className="pt-28 pb-10">
          <div className="cart-items bg-white p-4 rounded-lg shadow-lg transition-transform transform hover:translate-y-2 h-auto w-[60%] mx-auto bg-gray-200">
            <h2 className="text-3xl font-bold mb-4 text-center text-gray-800">Your Cart</h2>
            <div className="w-full border border-2 border-black flex  items-center p-4">
                <div className="lg:text-xl font-semibold mr-[70px]">
                    <p>"{CartPlan.name} Membership - in Now & Enjoy All 5 Widgets!” has been added to your cart.</p>
                </div>
              ...
              items.map((item) => (
                ...
                >
                  ...
                  <div className="text-lg font-semibold text-gray-800 flex flex-col gap-2">
                    <p className="text-gray-500 text-md">Total Price:  ${item.price * item.quantity}</p>
                    <button
              ...
              <div className="cart-summary mt-6 text-center">
                ...
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className="pay-button mt-4 w-1/3 bg-blue-500 text-white py-2 rounded-md hover:bg-blue-400 transition-colors"
                  >
